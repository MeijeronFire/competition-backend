...
- Built-in python libraries for hashing and for generating tokens.

- Jinja2 templating in combination with a bootstrap framework and some GET and POST endpoints to serve webpages and forms.

- Websocket connections for JS in the webpages to connect to, facilitating real time communication for state changes and admin commands and events. 